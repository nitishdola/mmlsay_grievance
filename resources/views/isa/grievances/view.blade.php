        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table mb-0 table-bordered">
                    ...
                    <form class="form-inline" action="{{ route('isa.grievance.process', $result->id) }}" enctype="multipart/form-data" method="post">
                    @csrf
                    <table class="table mb-0 table-bordered">
                        <tr>
                            <th>Action</th>
                            ...
                            <div class="mt-3">
                                ...
                                <textarea rows="4" class="form-control" name="isa_remarks"></textarea>
                            </div>
